 ...
 */
router.post('/register', authLimiter, validateSchema(schemas.register), authController.register);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/login', authLimiter, validateSchema(schemas.login), authController.login);
